...
const faqs = [
    {
        ...
        answer: 'You can book directly through our website by selecting your preferred villa, dates, and completing the checkout process. Alternatively, you can contact us via WhatsApp or email for personalized assistance.',
    },
    {
        question: 'What is the cancellation policy?',
        answer: 'Cancellations made 14+ days before check-in receive a full refund. 7-14 days receives 50% refund. Less than 7 days is non-refundable. Special conditions may apply during peak seasons.',
    },
    {
        question: 'Is airport pickup included?',
        answer: 'Airport pickup is available as an add-on service for IDR 350,000 (up to 4 passengers). We can arrange pickup from Ngurah Rai International Airport (approximately 1.5 hours to Ubud).',
    },
    {
        question: 'What amenities are included?',
        answer: 'All villas include: Private pool, fully equipped kitchen, AC, WiFi, daily housekeeping, welcome basket, toiletries, and 24/7 concierge service. Specific amenities vary by villa.',
    },
    {
        question: 'Can I extend my stay?',
        answer: 'Yes! Subject to availability, you can extend your stay. Please contact our team at least 24 hours before your original check-out date to arrange an extension.',
    },
    {
        question: 'How do I make payment?',
        answer: 'We accept bank transfer (BCA), credit/debit cards, and Indonesian e-wallets (GoPay, OVO, DANA). Payment is required within 24 hours of booking to confirm your reservation.',
    },
];
        ...
        <div className="min-h-screen bg-[#F1F3E0]">
                            ...
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-[#6b7c67]">
                                        Jl. Monkey Forest No. 123<br />
                                        Ubud, Gianyar, Bali 80571<br />
                                        Indonesia
                                    </p>
                                </div>
                            </div>
            ...
            <section className="py-16 px-4 bg-white">
                <div className="max-w-3xl mx-auto">
                    <h2 className="text-3xl font-serif font-bold text-[#2d3a29] text-center mb-12">
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq, index) => (
                            <div key={index} className="border border-[#d4dbc8] rounded-xl overflow-hidden">
                                ...
                                {openFaq === index && (
                                    <div className="px-5 pb-5 text-[#6b7c67]">{faq.answer}</div>
                                )}
                            </div>
                        ))}
                    </div>
