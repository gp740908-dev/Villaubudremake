    ...
    <div className="min-h-screen bg-[#F1F3E0]">
            ...
            {categories.map((category) => (
              <button
                ...
                className={`px-5 py-2 rounded-full text-sm font-medium transition-colors ${
                  activeCategory === category ? "bg-[#778873] text-white" : "bg-white text-[#6b7c67] hover:bg-[#D2DCB6]"
                }`}
              >
                {category}
              </button>
      ...
      <section className="py-8 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {!isLoading && filteredImages.length === 0 && (
            <div className="text-center py-12 text-[#6b7c67]">No images found in this category.</div>
          )}
        </div>
      </section>
      ...
      {lightboxOpen && filteredImages.length > 0 && (
        ...
        >
          ...
          {/* Image */}
          <img
            src={filteredImages[currentImageIndex].image_url || "/placeholder.svg"}
          ...
          <div className="absolute bottom-8 left-0 right-0 text-center">
            <p className="text-white text-lg font-medium mb-1">{filteredImages[currentImageIndex].title}</p>
            <p className="text-white/60 text-sm">{filteredImages[currentImageIndex].category}</p>
          </div>
